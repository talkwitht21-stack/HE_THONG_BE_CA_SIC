...
|:---:|:---|:---|:---|
| `GPIO 4` | **DS18B20** (Nước) | Data (DQ) | Cần mắc thêm điện trở kéo (pull-up resistor) **4.7kΩ** nối giữa Data và 3.3V |
| `GPIO 5` | **DHT22** (Không khí) | Data | |
| `GPIO 14` | **Phao từ** (Mực nước) | Tín hiệu | Chân còn lại của phao từ nối xuống GND. ESP32 cấu hình `INPUT_PULLUP`. |
